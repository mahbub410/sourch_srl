...
DECODE(SUBSTR(a.tariff,1,2),'LT',(nvl(a.billed_unit,0)-nvl(b.billed_unit,0)),0) billed_unit_without_snapshot,
...
DECODE(SUBSTR(a.tariff,1,2),'LT',(nvl(a.billed_unit,0)-nvl(b.billed_unit,0)),0) billed_unit_not_under_snapshot,
